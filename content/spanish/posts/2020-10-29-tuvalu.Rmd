...
ggplot(data_tuvalu) +
  ...
  theme(panel.background = element_rect(fill = lighten("#272822", 1.4), color = lighten("#272822", 1.2)),
        #panel.border =  element_rect(fill = "#272822", color = "#272822"),
        text = element_text(color = "white", family = "Didact Gothic"),
        axis.text = element_text(color = "white", family = "Didact Gothic"),
...
[Código](https://github.com/outlier-redemption/data-analysis/blob/main/02-tuvalu.R)

[Datos:WorldBank](https://data.worldbank.org/indicator/NY.GNP.MKTP.CD?locations=TV)
