...
tuvalu_map <- ggplot() +
  ...
  geom_sf(data = tiny_countries2, size = 1.5, color = paleta[1]) +
  annotate("text", x = 173, y = -5, label = "Tuvalu", color = "white", 
           family = "Didact Gothic", size = 3) +
...
tuvalu_map
ggsave(here::here("static", "img", "tuvalis.png") , dpi = 300, bg = "#272822", width = 4.38, height = 2.7)
```
